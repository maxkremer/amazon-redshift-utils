begin;
lock table public.event_click_%api_token%;
create table public.event_click_%api_token%_$mig(
...
,"coupon" varchar(64)   encode lzo 
 ...
 ;
insert into public.event_click_%api_token%_$mig  select * from public.event_click_%api_token%;
analyze public.event_click_%api_token%_$mig;
drop table public.event_click_%api_token% cascade;
alter table public.event_click_%api_token%_$mig rename to event_click_%api_token%;
commit;
